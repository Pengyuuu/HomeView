...
namespace Managers.Contracts
{
    ...
    {
        bool CheckReviewFields(string titleSelected, int uRating, string uReview);
        ...
        bool SubmitReviewRating(string dispName, string titleSelected, int uRating, string uReview);
        bool UpdateReviewRating(string dispName, string titleSelected, int uRating, string uReview);
    }
}