...
namespace RegistrationTests
{
    public class RegistrationTests
    {
        ...
        public void Register_ShouldRegisterUserSuccess()
        {
            ...
            bool actual = _registrationManager.AsyncCreateUser("testing@gmail.com","2000-12-09", "TestPassword!12344556755").Result;
        ...
        public void Register_ShouldRegisterUserUnsuccess()
        {
            ...
            bool actual = _registrationManager.AsyncCreateUser("csulbtestingtestingtesting@gmail.com", "2000-12-09", "TestPassword!12344556755").Result;
